...
- [`NewBascetCountMatrix()`](https://henriksson-lab.github.io/zorn/reference/NewBascetCountMatrix.md)
...
- [`PrependBascetCountMatrixName()`](https://henriksson-lab.github.io/zorn/reference/PrependBascetCountMatrixName.md)
...
- [`bascetCheckOverwriteOutput()`](https://henriksson-lab.github.io/zorn/reference/bascetCheckOverwriteOutput.md)
  : Detect metadata for raw input FASTQ files
- [`checkTotalMemArg()`](https://henriksson-lab.github.io/zorn/reference/checkTotalMemArg.md)
