...
Count sketching relies on the following ideas: \* Genomes can be
...
To first compute the project KMER counts, we will use the
...
rather unique. *The KMER length is typically odd*, to remove KMERs
symmetric under reverse complement (e.g., AATT) \* *The reduced number
of dimensions must be a power of two*, such as 2\*\*n. Or: 2048, 4096,
8192, 16384 etc. This restriction is due to the choice of underlying
algorithm.
