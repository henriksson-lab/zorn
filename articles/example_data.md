...
### Full WGS simulation (small)

To test the full pipeline, we have prepared simulated Atrandi WGS raw
FASTQ files:
...
### Debarcoded WGS simulation (small)

You can use [shardified
reads](http://beagle.henlab.org/public/bascet/demodata/simulated.zip) as
input. There are few cells, of different depth. This is our smallest
...
You can also investigate some [miseq data (Atrandi
WGS)](http://beagle.henlab.org/public/bascet/demodata/miseq.zip).
