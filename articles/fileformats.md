...
TIRP (Tabix-indexed read pairs) is a bgzip’ed text file with the
following columns, separated by a tab:
...
To keep track of the cellular origin, reads in BAM files typically
