...
SNP-analysis can also be use to separate cells from different donors.
...
The output files from SNP-analysis are directly compatible with [Vireo](https://github.com/single-cell-genetics/vireo).
See their tutorials for how to perform this analysis.
