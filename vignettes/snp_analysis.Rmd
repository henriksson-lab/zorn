...
SNP-analysis relies on having data aligned to a reference. First follow the 
...
is done by calling the integrated CellSNP-lite. 
*The input data must be position sorted reads*.
