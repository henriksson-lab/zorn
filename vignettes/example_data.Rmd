...
To test the full pipeline, we have prepared simulated Atrandi WGS raw FASTQ files:
...
You can also investigate some [miseq data (Atrandi WGS)](http://beagle.henlab.org/public/bascet/demodata/miseq.zip).
