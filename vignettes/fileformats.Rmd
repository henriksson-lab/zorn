...
Reads in Bascet-FASTQ should be sorted by (cellID, read_number, read_index),
...
are not named according to the FASTQ scheme, tools must instead scan for tags:
...
Our format is very similar to the [Anndata count matrix format](https://anndata.readthedocs.io).
We may however need to further adjust our writers for conformity. We provide our own compatible readers.
