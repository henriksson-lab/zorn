...
# If you have a few input FASTQ files

There is a special file format, "list-fastq", which is a TSV that simply consists of
* A name for each sample
* Links to raw FASTQ-files
...
# If you have really many FASTQ files
...
2. In a separate bulk working directory, Use Bascet transform to convert a list-FASTQ to TIRP
