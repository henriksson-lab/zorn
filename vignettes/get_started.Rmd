...
-   [Isolate/SRA-workflow](sra_fetching.html) - Load raw read isolate data for processing
-   [Isolate/NCBI-workflow](ncbi_genomes.html) - Load isolate assembled genome data for processing
...
-   [Doublet removal](doublet_removal.html) - to flag and remove cells that are mixtures of two cells
...
-   [Atrandi short-read WGS with host removal](ex_atrandi_host.html)

These may help you understand the design of Zorn and Bascet:

-   [Overview of file formats](fileformats.html)
-   [The types of Bascet-ZIP files](bascet_zip.html)
-   [Working with Bascet-FASTQ](bascet_fastq.html)
