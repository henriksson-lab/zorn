...
> in their "light" format (i.e., which cell the read belongs to).
...
is why we already perform our own trimming during Debarcode*). In either case, FASTP can
...
> ⚠️ Don't forget to specify inputName="new_filtered" to later commands, as the default
> is to use "filtered"
